...
```bash
git clone https://github.com/CrystalAlembic/kimiko-486.git
cd kimiko-486
python setup.py
```
...
[![CI](https://github.com/CrystalAlembic/kimiko-486/actions/workflows/ci.yml/badge.svg)](https://github.com/CrystalAlembic/kimiko-486/actions/workflows/ci.yml)
...
<!-- Last updated: 2026-06-05 13:29:04 -->
